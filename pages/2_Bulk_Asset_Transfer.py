...
with col1:
    sender_token = st.text_input("Please enter the Token of the Sender User", placeholder="b9b196762a596c94a74cf42ff9672bc6174c5d9f")    
    headers_sender = {
...
with col2:
    receiver_token = st.text_input("Please enter the Token of the Receiver User", placeholder="fed2149b17a4ce41b152ea21976b6239f46aee39")
    headers_receiver = {
...
if(assets_json.status_code == 200):
    ...
    df_assets = pd.DataFrame([
        {"uid": asset['uid'], "name": asset["name"]}
        for asset in assets
    ])

    selected_names = st.multiselect(
        "Select assets to transfer",
        options= df_assets["name"].tolist()
    )
